...
def most_common_nmer(file_path, file_type, nmer=7):
    ...
    # The most common nmer is the nmer_dict key which has the maximum value.
...
if __name__ == '__main__':
    ...
    # Printing the result.
    print("Most common {}-mer is '{}' (appears {} times) "
      "with a GC percentage of {:.2f}%.".format(
      args.nmer, *most_common_nmer(args.file_path, args.file_type, args.nmer)))
